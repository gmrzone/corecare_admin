...
import RecentActiveOrders from '../components/home/RecentActiveOrders'
const Index = () => {
    return (
        <MainLayout>
            <div className={style['dashboard-container']}>
                ...
                <div className={style['double-component']}>
                    <AreaChart heading="Orders" data={[300, 295, 200, 300, 600, 800, 100, 400, 300, 250, 560, 196]} target={300} chartBG='rgba(54, 162, 235, 0.4)' chartBorder="rgba(0, 7, 102, 0.8)" LineColor='rgb(255, 77, 103)'/>
