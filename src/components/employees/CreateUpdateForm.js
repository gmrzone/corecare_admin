const CreateUpdateForm = ({ register, formErrors, serverErrors }) => {
    return (
        <>
            ...
            <div class={`ui red message ${formErrors.number || formErrors.password || formErrors.first_name || formErrors.last_name || formErrors.username || formErrors.category || formErrors.email || formErrors.address_1 || formErrors.address_2 || formErrors.city || formErrors.state || formErrors.pincode || serverErrors ? "visible" : "hidden"}`}>
