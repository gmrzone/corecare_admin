    ...
    return (
        <>
                ...
                <div className={`field ${formErrors.body && "error"}`}>
                    <label>Body</label>
                    <textarea placeholder="Post Body"{...register('body', {required: {value: true, message: "Cannot Create A Post without Body"}, minLength: {value: 5, message: "Post Body cannot be less then 200 Char"}})}/>
                </div>
                <div className="field">
