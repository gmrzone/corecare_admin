        ...
        <div className={style.sidebar}>
            ...
            <div className={`${style.slider} ${sideDrawerActive && style["slider-active"]}`} onMouseOver={DesktopSliderMouseOver} onMouseOut={DesktopSliderMouseOut}>
                <ul className={style["slider-items-list"]} onClick={itemClick}>
                    ...
                    <li>
                        <NewLink
                            className={`${style["slider-item"]} ${history.location.pathname === "/employees" && style["active-item"]}`}
                            to="/employees">
                    ...
                    <li>
                        <NewLink
                            className={`${style["slider-item"]} ${history.location.pathname === "/users" && style["active-item"]}`}
                            to="/users">
                    ...
                    <SliderDropDownItem
                        name="Products"
                        activeTab={history.location.pathname === "/services" || history.location.pathname === "/subcategory"}
                    ...
                    <SliderDropDownItem
                        name="Blog"
                        activeTab={history.location.pathname === "/posts" || history.location.pathname === "/comments"}
                        sideDrawerActive={sideDrawerActive}
                        iconClass="blogger icon">
                        <li onClick={itemClick}>
                    ...
                    <li>
                        <NewLink
                            className={`${style["slider-item"]} ${history.location.pathname === "/coupons" && style["active-item"]}`}
                            to="/coupons">
